                ...
                <div className="terms-container">
                    <div className="terms">
                        ...
                        <div className="terms-text">
                            ...
                            by CuteManga (”we”, “us”, “our”). By using our site, you agree with these terms. If you do not agree with these 
                    ...
                    <div className="privacy" id="privacy" onMouseOver={() => setOnPrivacy(true)} onMouseLeave={() => setOnPrivacy(false)}>
                        ...
                        <div className="privacy-text">
                            ...
                            This Privacy Policy outlines the information that CuteManga (”we”, “us”, “our”) 
