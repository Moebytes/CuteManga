        ...
        <div className="footer">
            ...
            <div className="footer-row">
                <span className="footer-text">
                    ...
                    We do not own any manga and we do not profit off of them. If you like a manga then support the artist/publisher by buying it. 
                    If you are an artist/publisher and want your content removed, contact us.
                </span>
            </div>
        </div>
    )
